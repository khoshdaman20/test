    ...
    try {
      ...
      if ((password == confermpass) & (Checkvalidation(password) == "OK")) {
        ...
        axios
          ...
          .then(function (response) {
            ...
            if (response.data.body == "OK") {
              ...
              Alert.alert(
                "تغییر کلمه عبور",
                "کلمه عبور با موفقیت تغیید یافت. لطفا مجددا وارد شوید.",
                [
                  {
                    text: "ok",
        ...
        if (Checkvalidation(password) != "OK") {
          Toast.show({
            title: "فرمت کلمه عبور اشتباه است. ",
            backgroundColor: "#ff0000",
            textStyle: { fontFamily: "IRANSansMobile", fontSize: 12 },
            duration: 3000,
          });
          ...
          Toast.show({
            title: "عدم تطابق کلمه عبور و تکرار آن",
