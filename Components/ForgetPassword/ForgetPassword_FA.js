...
function ForgetPassword_FA(props, { navigation }) {
  var username = "";
  var password = "";
  var birthday = "";
  var passportcode = "";
                ...
                axios
                  ...
                  .then(function (response) {
                    ...
                    if (
                      ...
                      Toast.show({
                        title: "حساب شما مسدود شده است به شعبه مراجعه نماییر",
                        backgroundColor: "#ff0000",
                        textStyle: {
                          fontFamily: "IRANSansMobile",
                          fontSize: 12,
...
export default ForgetPassword_FA;
