...
function OTP_Forgetpassword_EN(props, { navigation }) {
  //var accountNumbers = props.route.params.Accno;
  // var isFinisheDur = false;
  var OTPCode = "";
  var NewOTP = props.route.params.OTPCode;
            ...
            try {
              ...
              axios
                ...
                .then(function (response) {
                  ...
                  console.log(Log[0].req + " - " + OldOTPCODE);
                  console.log(
                    "OTPCode == OldOTPCODE" + OTPCode + "==" + NewOTPState
                  );
                  if (isFinisheDur == true) {
                    Toast.show({
...
export default OTP_Forgetpassword_EN;
